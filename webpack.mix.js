...
let third_party_assets = {
    files: [
        {"name": "jquery", "filename": "jquery", "assets": ["./node_modules/jquery/dist/jquery.min.js"]},
        {"name": "bootstrap","filename": "bootstrap",  "assets": ["./node_modules/bootstrap/dist/js/bootstrap.bundle.js"]},
        {"name": "metismenu", "filename": "metismenu", "assets": ["./node_modules/metismenu/dist/metisMenu.js"]},
        {"name": "simplebar", "filename": "simplebar", "assets": ["./node_modules/simplebar/dist/simplebar.js"]},
        {"name": "node-waves", "filename": "node-waves", "assets": ["./node_modules/node-waves/dist/waves.js"]},
        {"name": "select2", "filename": "select2", "assets": ["./node_modules/select2/dist/js/select2.min.js", "./node_modules/select2/dist/css/select2.min.css"]},
        ...
        },
        {
            ...
            "assets": [
                ...
                "./node_modules/trumbowyg/plugins/table/ui/trumbowyg.table.css"
            ]
        },
        {
            ...
            "assets": [
                ...
                "./node_modules/trumbowyg/plugins/colors/ui/trumbowyg.colors.css"
            ]
        },
        {
            ...
            "assets": [
                ...
                "./node_modules/trumbowyg/plugins/cleanpaste/ui/trumbowyg.cleanpaste.css"
            ]
        },
        {
            ...
            "assets": [
                ...
                "./node_modules/trumbowyg/plugins/history/ui/trumbowyg.history.css"
            ]
        },
        {
            ...
            "assets": [
                ...
                "./node_modules/trumbowyg/plugins/indent/ui/trumbowyg.indent.css"
            ]
        },
        {
            ...
            "assets": [
                ...
                "./node_modules/trumbowyg/plugins/pasteimage/ui/trumbowyg.pasteimage.css"
            ]
        },
        {
            ...
            "assets": [
                ...
                "./node_modules/trumbowyg/plugins/resizimg/ui/trumbowyg.resizimg.css"
            ]
        },
        {
            ...
            "assets": [
                ...
                "./node_modules/trumbowyg/plugins/upload/ui/trumbowyg.upload.css"
            ]
        },
        {
            "name": "datatables",
...
lodash.forEach(third_party_assets, function (assets, type) {
    lodash.forEach(assets, function (plugin) {
        ...
        if (css.length > 0) {
            mix.combine(js, folder.asset_dest + "/libs/" + name + "/" + filename + ".min.css");
        }
    })
})
